...
import os
stock_data = {'LICI.BO': 'LIC', 'TCS.BO': 'TCS', 'GSFC.BO': 'GSFC', 'BCLIND.BO': 'BCL Industries', 'IFCI.BO': 'IFCI','CENTRALBK.BO':'CBI','IDEA.BO':'VI','HDFCBANK.BO':'HDFC Bank','COALINDIA.BO': 'Coal India', 'HUDCO.BO': 'HUDCO', 'ONGC.BO': 'ONGC', 'ADANIGREEN.BO': 'Adani Green', 'VEDL.BO': 'Vedanta', 'PAYTM.BO': 'Paytm', 'TITAN.BO': 'Titan', 'GAIL.BO': 'GAIL'}
scheduler=None
def check_market():
...
stock_frame.place(relx=0.05, rely=0.08)
check_market()
get_stock_prices()
